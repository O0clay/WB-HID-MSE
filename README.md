...
WB-HID-MSE (µPoint) is a custom-designed, ultra-low-power Bluetooth Low Energy (BLE) Human Interface Device (HID) mouse built around the STM32WB series microcontroller. The project focuses on modular hardware design, power efficiency, and embedded firmware architecture.
